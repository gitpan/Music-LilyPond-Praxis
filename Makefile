# This Makefile is for the Music::LilyPond::Praxis extension to perl.
#
...
#     ABSTRACT => q[LilyPond utility classes]
#     AUTHOR => q[Jeremy Mates <jmates@sial.org]
#     DIR => []
#     DISTNAME => q[Music-LilyPond-Praxis]
#     NAME => q[Music::LilyPond::Praxis]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { ExtUtils::MakeMaker=>q[6.54] }
#     VERSION => q[0.01]
#     dist => {  }
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Music::LilyPond::Praxis
NAME_SYM = Music_LilyPond_Praxis
VERSION = 0.01
...
MAKEMAKER   = /Users/jmates/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.54
MM_REVISION = 65400
...
MAKE = make
FULLEXT = Music/LilyPond/Praxis
BASEEXT = Praxis
PARENT_NAME = Music::LilyPond
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Music/LilyPond/Scale/Chromatic.pm \
	lib/Music/LilyPond/Set.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Music/LilyPond
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Music/LilyPond
...
TO_INST_PM = lib/Music/LilyPond/Scale/Chromatic.pm \
	lib/Music/LilyPond/Set.pm

PM_TO_BLIB = lib/Music/LilyPond/Set.pm \
	blib/lib/Music/LilyPond/Set.pm \
	lib/Music/LilyPond/Scale/Chromatic.pm \
	blib/lib/Music/LilyPond/Scale/Chromatic.pm
...
DISTNAME = Music-LilyPond-Praxis
DISTVNAME = Music-LilyPond-Praxis-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Music/LilyPond/Set.pm $(INST_MAN3DIR)/Music::LilyPond::Set.$(MAN3EXT) \
	  lib/Music/LilyPond/Scale/Chromatic.pm $(INST_MAN3DIR)/Music::LilyPond::Scale::Chromatic.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>LilyPond utility classes</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Jeremy Mates &lt;jmates@sial.org</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="ExtUtils::MakeMaker" VERSION="6.54" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Music/LilyPond/Set.pm blib/lib/Music/LilyPond/Set.pm \
	  lib/Music/LilyPond/Scale/Chromatic.pm blib/lib/Music/LilyPond/Scale/Chromatic.pm 
